...
export function InvoiceListPage(props: InvoiceListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'payment_status', header: 'payment_status', accessorKey: 'payment_status' },
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_invoice_mechanic_idTouser',
          header: 'User Invoice Mechanic Id Touser',
          accessorKey: 'user_invoice_mechanic_idTouser',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/users/view/${record.user_invoice_mechanic_idTouser?.id}`}
            >
              {record.user_invoice_mechanic_idTouser?.email}
            </Link>
          ),
        }
      : null,
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_invoice_accountant_idTouser',
          header: 'User Invoice Accountant Id Touser',
          accessorKey: 'user_invoice_accountant_idTouser',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/users/view/${record.user_invoice_accountant_idTouser?.id}`}
            >
              {record.user_invoice_accountant_idTouser?.email}
            </Link>
          ),
        }
      : null,
