...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`garage invoice system`}</title>

        <meta
          name="description"
          content="Welcome to Garage Invoice System - Streamlining Your Car Garage Operations with Efficient Invoice Management."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1515569067071-ec3b51335dd0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXIlMjBnYXJhZ2UlMkNpbnZvaWNlfGVufDB8fHx8MTY4OTc2NjY2OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Garage Invoice System - Streamlining Your Car Garage Operations with Efficient Invoice Management.`}
            </Text>
            <Box
